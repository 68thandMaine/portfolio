                      ...
                      <div className='personalProjects'>    
                        ...
                        <div className='footer-links'>
                          <div className='projectLinks'>
                            <a className='cardIcons'href={project.readMeURL}><i className="fab fa-readme fa-2x" /></a>
                            <label className='linkLabel'>Readme</label>
                          </div>
                          <div className='projectLinks'>
                            <a className='cardIcons'href={project.githubURL}><i className='fab fa-github fa-2x' /></a>
